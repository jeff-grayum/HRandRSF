...
FL_og <- fl_pred_draws_sum %>%
  ...
  geom_line() +
  geom_ribbon(aes(ymin = low_ci, ymax = upper_ci), fill = "black", alpha = 0.4) +
  labs(x = "Distance to FL (original scale)", 
       y = "Probability of selection") +
  theme_bw() +
  theme(
    panel.grid.major = element_blank(),
    ...
    legend.title = element_text(colour = "black", size = 12, family = "Times New Roman"),
    legend.text = element_text(colour = "black", size = 12, family = "Times New Roman"),
    plot.title = element_text(colour = "black", size = 14, family = "Times New Roman")
  )
...
NP_BU_og <- np_bu_pred_draws_sum %>%
  ...
  geom_line() +
  geom_ribbon(aes(ymin = low_ci, ymax = upper_ci), fill = "#006400", alpha = 0.4) +
  labs(x = "Distance to NP_BU (original scale)", 
       y = "Probability of selection") +
  theme_bw() +
  theme(
    panel.grid.major = element_blank(),
...
SS_UB_og <- ss_ub_pred_draws_sum %>% 
  ...
  geom_line() +
  geom_ribbon(aes(ymin = low_ci, ymax = upper_ci), fill = "gray50", alpha = 0.5) +
  labs(x = "Distance to SS_UB (original scale)", 
       y = "Probability of selection") +
  theme_bw() +
  theme(
    panel.grid.major = element_blank(),
...
HP_UB_og <- hp_ub_pred_draws_sum %>%
  ...
  geom_line() +
  geom_ribbon(aes(ymin = low_ci, ymax = upper_ci), fill = "brown", alpha = 0.4) +
  labs(x = "Distance to HP_UB (original scale)", 
       y = "Probability of selection") +
  theme_bw() +
  theme(
    panel.grid.major = element_blank(),
...
NP_UB_og <- np_ub_pred_draws_sum %>%
  ...
  geom_line() +
  geom_ribbon(aes(ymin = low_ci, ymax = upper_ci), fill = "#006400", alpha = 0.4) +
  labs(x = "Distance to NP_UB (original scale)", 
       y = "Probability of selection") +
  theme_bw() +
  theme(
    panel.grid.major = element_blank(),
...
SS_BU_og <- ss_bu_pred_draws_sum %>% 
  ...
  geom_line() +
  geom_ribbon(aes(ymin = low_ci, ymax = upper_ci), fill = "gray50", alpha = 0.5) +
  labs(x = "Distance to SS_BU (original scale)", 
       y = "Probability of selection") +
  theme_bw() +
  theme(
    panel.grid.major = element_blank(),
...
hp_bu_pred_draws_sum <- hp_bu_pred_draws_sum %>%
  mutate(
    HP_BU_original = (HP_BU * 205.82) + 234.62  # Transform scaled to original
  )
...
HP_BU_og <- hp_bu_pred_draws_sum %>% 
  ...
  labs(x = "Distance to HP_BU (original scale)", 
       y = "Probability of selection") +
  theme_bw() +
  theme(
    panel.grid.major = element_blank(),
