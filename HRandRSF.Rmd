...
Summarizing data from winter 2021/22 land cover availability, some exploratory analysis.
```{r}
...
Differences in use vs availability
```{r}
...
#Finding median availabiity, median selection, and difference
