...
Summer_2022_locs <- rio::import("/Volumes/Samsung_T5/BOBWHITE_DATA/Clean/SummerLocations/Summer2022/All_Summer_2022_LOCS_CLEAN_NO_Nests.xlsx", setclass = "tibble") %>%
  clean_names() %>%
  filter(status != "D") %>%
...
coefficients_data_no_intercept %>%
  ...
  ggtitle('2022: Beta coefficients for all age and sex classes') +
  theme_minimal()
