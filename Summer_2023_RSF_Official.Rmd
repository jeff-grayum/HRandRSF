...
#Making tibble of number of lcov locs
...
all_covs_pred <- rbind(np_bu_pred_draws_sum_piv, ag_pred_draws_sum_piv, ss_ub_pred_draws_sum_piv, hw_pred_draws_sum_piv, hp_bu_pred_draws_sum_piv, np_ub_pred_draws_sum_piv)
...
all_covs_pred$Covariate <- fct_relevel(all_covs_pred$Covariate, "NP_BU","SS_UB", "AG", "NP_UB", "HW", "HP_BU")
