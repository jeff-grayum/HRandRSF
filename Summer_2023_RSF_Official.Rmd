...
Creating tibbles for RSF, adding sex of nobo
```{r}
...
rsfData_summer2023 <- rsfData_summer2023 %>%
  left_join(fate %>% select(band_numb, sex), by = "band_numb")

#Taking a quick look.
head(rsfData_summer2023)

#Creating column "case" where TRUEs (known points) have value of 1, and Falses (random points) have value of 0. Centeringand and sclaing our covariates.
