...
#Fitting glm
pop.rsf_summer2022 <- glmer(case ~ AG + NP + PP +  HW + SS + UM + WL + (1|band_numb),
...
Let's try looking at males.
```{r}
#### Looking at males only ####
...
pop.rsf_summer2022_bayes <- brm(
  ...
  case | trials(1) ~ AG + PP + NP + HW + SS + UM + WL + band_numb,
